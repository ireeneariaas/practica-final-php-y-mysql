...
<form action="cerrar_sesion.php" method="post">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<div style='text-align: center;'><button type='submit'>Modificar</button></div>";
    } else {
    ...
    // Mostrar el mensaje después del div1
    echo "<div style='text-align: center; margin-top: 20px;'>$mensaje</div>"; 
